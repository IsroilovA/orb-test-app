...
@immutable
final class OrbColorScheme extends ThemeExtension<OrbColorScheme> {
  ...
  @override
  OrbColorScheme lerp(ThemeExtension<OrbColorScheme>? other, double t) {
    if (other is! OrbColorScheme) return this;
    return OrbColorScheme(
  ...
  @override
  String toString() =>
      'OrbColorScheme(primary: $primary, secondary: $secondary, '
      'surface: $surface, onSurface: $onSurface, outline: $outline)';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is OrbColorScheme &&
