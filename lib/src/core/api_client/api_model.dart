...
/// Clones a [BaseRequest] so it can be sent again (e.g. after token refresh or retry).
///
/// [StreamedRequest] cannot be cloned because its body stream is consumed on
/// the first read.
BaseRequest cloneBaseRequest(ApiClientRequest request) {
  ...
  if (request is StreamedRequest) {
    throw UnsupportedError(
      ...
      'The body stream is consumed on the first attempt and cannot be rewound.',
    );
  }
